      ...
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-3 px-2 sm:px-4">
        ...
        <NavigationMenu viewport={false} className="hidden md:block">
          <NavigationMenuList className="gap-2">
            ...
            <NavigationMenuItem>
              <NavigationMenuTrigger className="rounded-full px-4 text-lg font-medium transition-all duration-200 hover:border-border/70 hover:bg-secondary/70 focus:bg-secondary/70">
